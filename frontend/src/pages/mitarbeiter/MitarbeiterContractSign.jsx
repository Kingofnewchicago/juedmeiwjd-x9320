...
const MitarbeiterContractSign = ({ applicant, onContractSigned }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF7ED] via-white to-[#FFEDD5] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-3xl">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-[#F97316] font-medium">Bewerbung akzeptiert</span>
          </div>
          <div className="w-8 h-px bg-[#F97316]"></div>
          <div className="flex items-center gap-2">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
          ...
          <div className="bg-[#0A0A0A] text-white p-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-xl bg-[#F97316] flex items-center justify-center">
          ...
          <div className="p-8 space-y-8">
            ...
            <div>
              ...
              <Input
                ...
                placeholder=""
                className="h-12 text-lg font-mono tracking-wider border-slate-200 focus:border-[#F97316] focus:ring-[#F97316]"
            ...
            <div>
              <Label className="text-[#0A0A0A] font-semibold flex items-center gap-2 mb-2">
                <PenTool size={18} className="text-[#F97316]" />
                Ihre Unterschrift
              </Label>
              <div className="border-2 border-dashed border-slate-300 rounded-xl bg-white hover:border-[#F97316] transition-colors">
                <SignatureCanvas
                  ref={signatureRef}
                  canvasProps={{
              ...
              <button
                ...
                className="mt-2 text-sm text-slate-500 hover:text-[#F97316] flex items-center gap-1"
              >
                <RotateCcw size={14} />
            ...
            <Button
              onClick={handleSign}
              disabled={isSigning}
              className="w-full h-14 bg-[#F97316] hover:bg-[#EA580C] text-white text-lg font-semibold rounded-xl"
            ...
            {canSkip && (
              <div className="pt-2">
                <button
                  ...
                  className="w-full h-12 flex items-center justify-center gap-2 text-slate-600 hover:text-[#F97316] border border-slate-200 hover:border-[#F97316] rounded-xl transition-colors disabled:opacity-50"
