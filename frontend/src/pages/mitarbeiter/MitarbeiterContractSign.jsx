...
const MitarbeiterContractSign = ({ applicant, onContractSigned }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#EEF1FF] via-white to-[#E0E4FF] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-3xl">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-[#6366F1] text-white flex items-center justify-center text-sm font-bold">
              <CheckCircle size={16} />
            </div>
            <span className="text-sm text-[#6366F1] font-medium">Bewerbung akzeptiert</span>
          </div>
          <div className="w-8 h-px bg-[#6366F1]"></div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-[#6366F1] text-white flex items-center justify-center text-sm font-bold">2</div>
          ...
          <div className="bg-[#0A0A0A] text-white p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400">MORE Applications · {positionLabel}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div>
              ...
              <Input
                ...
                placeholder=""
                className="h-12 text-lg font-mono tracking-wider border-slate-200 focus:border-[#6366F1] focus:ring-[#6366F1]"
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-slate-300 rounded-xl bg-white hover:border-[#6366F1] transition-colors">
                <SignatureCanvas
                  ref={signatureRef}
                  canvasProps={{
              ...
              <button
                ...
                className="mt-2 text-sm text-slate-500 hover:text-[#6366F1] flex items-center gap-1"
              >
                <RotateCcw size={14} />
            ...
            <Button
              onClick={handleSign}
              disabled={isSigning}
              className="w-full h-14 bg-[#6366F1] hover:bg-[#4F46E5] text-white text-lg font-semibold rounded-xl"
            ...
            {canSkip && (
              <div className="pt-2">
                <button
                  ...
                  className="w-full h-12 flex items-center justify-center gap-2 text-slate-600 hover:text-[#6366F1] border border-slate-200 hover:border-[#6366F1] rounded-xl transition-colors disabled:opacity-50"
